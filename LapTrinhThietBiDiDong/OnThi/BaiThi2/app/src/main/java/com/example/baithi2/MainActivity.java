...
//        mysql.addContact(new HoaDon_3107("Ngô Văn Khải", 244, 20000, 100));
...
//        mysql.addContact(new HoaDon_3107("Mạc Văn Minh", 802, 10500, 100));
        ...
        editSearch.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                //adapter_de02.getFilter().filter(s);
                arrayList = mysql.getContactBySearch(s);

                adapter_de02 = new Adapter_De02(MainActivity.this, arrayList);
                listView.setAdapter(adapter_de02);
                return true;
            }
        });
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(MainActivity.this,"Nguyễn Thị Ngũ, Số lượng hóa đơn: " + count, Toast.LENGTH_LONG).show();
                return false;
            }
        });
    }
